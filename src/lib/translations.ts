...
const en = {
    ...
    bookDemo: {
      ...
      successBody: "We've sent a calendar invite with a Google Meet link to your email.",
      successWhen: "When:",
...
const pl: Translations = {
    ...
    bookDemo: {
      ...
      successBody: "Wysłaliśmy zaproszenie kalendarzowe z linkiem do Google Meet na Twój e-mail.",
      successWhen: "Kiedy:",
